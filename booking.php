            ...
            <div class="booking-form-container">
                <form action="" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="12-3">April 01,2024</option>
                        <option value="13-3">April 02,2024</option>
                        <option value="14-3">April 03,2024</option>
                        <option value="15-3">April 04,2024</option>
                        <option value="16-3">APril 05,2024</option>
                    </select>
